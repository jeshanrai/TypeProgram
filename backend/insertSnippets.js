...
// {"language":"swift","code":"func sum(a:Int,b:Int)->Int{return a+b}"},
// {"language":"swift","code":"func factorial(n:Int)->Int{return n<=1 ?1:n*factorial(n:n-1)}"},
// {"language":"swift","code":"func isPrime(n:Int)->Bool{if n<2{return false};for i in 2..<n{if n%i==0{return false}};return true}"},
// {"language":"swift","code":"func fibonacci(n:Int)->Int{return n<2 ?n:fibonacci(n:n-1)+fibonacci(n:n-2)}"},
// {"language":"swift","code":"func max(a:Int,b:Int)->Int{return a>b ?a:b}"},
// {"language":"swift","code":"func min(a:Int,b:Int)->Int{return a<b ?a:b}"},
// {"language":"swift","code":"func abs(x:Int)->Int{return x<0 ?-x:x}"},
// {"language":"swift","code":"func circleArea(r:Double)->Double{return Double.pi*r*r}"},
// {"language":"swift","code":"func isLeap(y:Int)->Bool{return y%4==0&&(y%100!=0||y%400==0)}"},
// {"language":"swift","code":"func gcd(a:Int,b:Int)->Int{return b==0 ?a:gcd(a:b,b:a%b)}"},
// {"language":"swift","code":"func lcm(a:Int,b:Int)->Int{return a*b/gcd(a:a,b:b)}"},
// {"language":"swift","code":"func power(b:Int,e:Int)->Int{return e==0 ?1:b*power(b:b,e:e-1)}"},
// {"language":"swift","code":"func sumDigits(n:Int)->Int{return String(n).compactMap{$0.wholeNumberValue}.reduce(0,+)}"},
// {"language":"swift","code":"func reverse(n:Int)->Int{return Int(String(String(n).reversed()))!}"},
// {"language":"swift","code":"func isPalindrome(n:Int)->Bool{return String(n)==String(String(n).reversed())}"},
// {"language":"swift","code":"func countDigits(n:Int)->Int{return String(n).count}"},
// {"language":"swift","code":"func isArmstrong(n:Int)->Bool{let s=String(n).compactMap{$0.wholeNumberValue}.map{pow(Double($0),3)}.reduce(0,+);return Int(s)==n}"},
// {"language":"swift","code":"func productDigits(n:Int)->Int{return String(n).compactMap{$0.wholeNumberValue}.reduce(1,*)}"},
// {"language":"swift","code":"func binaryToDecimal(b:String)->Int{return Int(b,radix:2)!}"},
// {"language":"swift","code":"func decimalToBinary(d:Int)->String{return String(d,radix:2)}"},
// {"language":"swift","code":"func isPerfectSquare(n:Int)->Bool{let s=Int(sqrt(Double(n)));return s*s==n}"},
// {"language":"swift","code":"func countSetBits(n:Int)->Int{return String(n,radix:2).filter{$0=="1"}.count}"},
// {"language":"swift","code":"func sumNatural(n:Int)->Int{return n*(n+1)/2}"},
// {"language":"swift","code":"func sumEven(n:Int)->Int{return n*(n+1)}"},
// {"language":"swift","code":"func sumOdd(n:Int)->Int{return n*n}"},
// {"language":"swift","code":"func sumSquares(n:Int)->Int{return n*(n+1)*(2*n+1)/6}"},
// {"language":"swift","code":"func sumCubes(n:Int)->Int{return n*n*(n+1)*(n+1)/4}"},
// {"language":"swift","code":"func lastDigit(n:Int)->Int{return abs(n)%10}"},
// {"language":"swift","code":"func firstDigit(n:Int)->Int{return Int(String(String(abs(n)).prefix(1))!}"},
// {"language":"swift","code":"func isPowerOfTwo(n:Int)->Bool{return n>0&&(n&(n-1))==0}"},
// {"language":"swift","code":"func countFactors(n:Int)->Int{return (1...n).filter{n%$0==0}.count}"},
// {"language":"swift","code":"func isEven(n:Int)->Bool{return n%2==0}"},
// {"language":"swift","code":"func isOdd(n:Int)->Bool{return n%2!=0}"},
// {"language":"swift","code":"func isPositive(n:Int)->Bool{return n>0}"},
// {"language":"swift","code":"func isNegative(n:Int)->Bool{return n<0}"},
// {"language":"swift","code":"func isZero(n:Int)->Bool{return n==0}"},
// {"language":"swift","code":"func isDivisible(a:Int,b:Int)->Bool{return a%b==0}"},
// {"language":"swift","code":"func toggleBit(n:Int,p:Int)->Int{return n^(1<<p)}"},
// {"language":"swift","code":"func setBit(n:Int,p:Int)->Int{return n|(1<<p)}"},
// {"language":"swift","code":"func clearBit(n:Int,p:Int)->Int{return n&~(1<<p)}"},
// {"language":"swift","code":"func swap(a:inout Int,b:inout Int){(a,b)=(b,a)}"},
// {"language":"swift","code":"func arraySum(a:[Int])->Int{return a.reduce(0,+)}"},
// {"language":"swift","code":"func arrayMax(a:[Int])->Int{return a.max()!}"},
// {"language":"swift","code":"func arrayMin(a:[Int])->Int{return a.min()!}"},
// {"language":"swift","code":"func arrayAvg(a:[Int])->Int{return a.reduce(0,+)/a.count}"},
// {"language":"swift","code":"func arrayContains(a:[Int],v:Int)->Bool{return a.contains(v)}"},
// {"language":"swift","code":"func arrayReverse(a:[Int])->[Int]{return a.reversed()}"},
// {"language":"swift","code":"func arrayCopy(a:[Int])->[Int]{return a}"},
// {"language":"swift","code":"func arrayEqual(a:[Int],b:[Int])->Bool{return a==b}"},
// {"language":"swift","code":"func arrayUnique(a:[Int])->[Int]{return Array(Set(a))}"},
// {"language":"swift","code":"func arrayMerge(a:[Int],b:[Int])->[Int]{return a+b}"}
...
async function insertSnippets() {
  try {
    ...
    if (existing > 0) {
      console.log('Snippets already exist. Skipping insert.');
    } else {

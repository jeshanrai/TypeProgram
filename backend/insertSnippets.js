...
// {"language":"easyMix","code":"The store opens at 9:00 AM and closes at 8:30 PM daily. Weekends (Saturday/Sunday) have extended hours until 9:00 PM! Call (555) 123-4567 for inquiries."},
// {"language":"easyMix","code":"Recipe: Mix 2 cups flour, 1 tsp salt, 3/4 cup sugar. Bake at 350°F for 25-30 mins. Serves 6-8 people. Tip: Add 1/2 cup chocolate chips for extra flavor!"},
// {"language":"easyMix","code":"Park rules: Open 6AM-10PM. No bikes on paths. Dogs must be leashed (max 6ft). Fines up to $50 for violations. Emergency #: (555) 987-6543."},
// {"language":"easyMix","code":"Flight AA123 departs at 3:45PM from Gate B7. Arrives 6:30PM. Baggage allowance: 1 carry-on (max 22x14x9in) + 1 personal item. Check-in closes 1hr before."},
// {"language":"easyMix","code":"Sale alert: 30% off all items (code: SAVE30) until 12/31/23. Exclusions apply*. Visit www.example.com or our 5 NYC locations!"},
// {"language":"easyMix","code":"Class schedule: Math (Room 201) 9:00-10:15AM, Science (Lab 3) 1:00-2:30PM. Office hours: M/W 3:00-4:00PM. Bring textbook & calculator!"},
// {"language":"easyMix","code":"Weather: Today 72°F (22°C), 20% rain chance. Sunset at 7:48PM. UV index 6 (high). Tomorrow: 68-75°F, 40% rain. Wind NE 5-10mph."},
// {"language":"easyMix","code":"Job requirements: High school diploma + 2yrs experience. Pay: $18.50/hr. Apply at hr@company.com by 11/15. Include resume & 3 references."},
// {"language":"easyMix","code":"Meeting reminder: Nov 10, 2:00-3:30PM in Conf. Room A. Agenda: Q3 results (see attached), 2024 budget (+12% vs 2023), new hires (2 positions)."},
// {"language":"easyMix","code":"Library: Due 11/20 (late fee $0.25/day). Renew online or call (555) 222-1111. Hours: M-Th 9AM-9PM, F 9AM-6PM, Sat 10AM-5PM, Sun 1-5PM."},
// {"language":"easyMix","code":"Event tickets: $25 adults, $15 kids (under 12). Group discount: 10% for 5+ people. Doors open 6PM, show starts 7:30PM. Parking: $10/car."},
// {"language":"easyMix","code":"Gym membership: $49.99/mo (12-mo contract) or $75/mo (no contract). Classes: Yoga M/W 7AM, Spin Tu/Th 6PM. Free trial until 12/1!"},
// {"language":"easyMix","code":"Computer specs: Windows 11, Intel i5-12400, 16GB RAM, 512GB SSD. Warranty: 2 years. Price: $899.99 ($100 off until Friday!). Free shipping."},
// {"language":"easyMix","code":"Bus schedule: #42 to downtown every 15min (peak) / 30min (off-peak). Last bus at 11:45PM. Fare: $2.50 (exact change) or use transit app."},
// {"language":"easyMix","code":"Hotel reservation: 2 queens, Nov 15-18. Rate: $129/night + 12% tax. Check-in 3PM, check-out 11AM. Pool hours: 7AM-10PM. WiFi included."},
// {"language":"easyMix","code":"Pizza order: Large (14) half pepperoni/half mushroom, 2-liter soda ($22.50). Delivery ETA 6:15-6:45PM. Call (555) 333-4444 to confirm."},
// {"language":"easyMix","code":"School lunch menu: Mon - Chicken sandwich (430 cal), Tue - Pasta (510 cal), Wed - Tacos (480 cal). Milk $0.50, juice $1.00. No nuts!"},
// {"language":"easyMix","code":"Car for sale: 2018 Honda Civic, 42,500mi, $18,999. MPG: 32 city/42 hwy. VIN: JHMCG5658GC012345. Test drives M-F 9AM-7PM. Ask for Bob."},
// {"language":"easyMix","code":"Doctor's note: Take 1 pill (500mg) every 8hrs with food. Refills: 2. Next appt: 1/10/24 at 10:30AM. Pharmacy: CVS #1234 (open until 10PM)."},
// {"language":"easyMix","code":"Concert: The Stars, Dec 5 @8PM. Tickets: $45-$120. Venue: Madison Sq. (Seat 12B, Row J). Parking: $30. Doors open 7PM. No cameras!"},
// {"language":"mediumMix","code":"The project deadline is 11/30/23 @11:59PM EST. Submit to portal (https://submissions.example.com). Max file size: 25MB (PDF/PPT only). Late penalty: 10%/day."},
// {"language":"mediumMix","code":"Lab results: pH 7.4, glucose 92mg/dL, WBC 6.5×10³/μL. Reference ranges: Na+ 135-145mmol/L, K+ 3.5-5.0mmol/L. Follow-up in 3 months (02/15/24)."},
// {"language":"mediumMix","code":"SQL query: SELECT * FROM customers WHERE state='NY' AND purchases > 1000 ORDER BY last_name ASC LIMIT 50; -- Last updated: 10/01/23 14:30 UTC"},
// {"language":"mediumMix","code":"Financial report Q3: Revenue $1.45M (+18% YoY), Expenses $987K. Net profit: $463K (31.9% margin). Projections: Q4 ~$1.6-1.8M (see Fig.3)."},
// {"language":"mediumMix","code":"Chemistry: 2H₂ + O₂ → 2H₂O (ΔH = -572kJ/mol). Experiment: Add 5mL 1M HCl to 0.5g Mg ribbon. Measure gas (H₂) volume at STP (22.4L/mol)."},
// {"language":"mediumMix","code":"CSS code: #header { font-size: 2.4rem; margin: 1.5em 0; } @media (max-width: 768px) { .sidebar { display: none; } } /* Updated 2023-10-02 */"},
// {"language":"mediumMix","code":"Physics exam: F=ma (N), KE=½mv² (J). Problem: 5kg mass @ 3m/s² → F=? (Ans: 15N). Constants: g=9.81m/s², c=3×10⁸m/s. Calculator allowed."},
// {"language":"mediumMix","code":"Legal notice: Case #2023-CV-05678. Hearing 12/05 @9:30AM (Courtroom 4B). Submit motions by 11/21. Penalty: $100/day late (max $1,000)."},
// {"language":"mediumMix","code":"API endpoint: POST /users/create HTTP/1.1\nContent-Type: application/json\nBody: {\"name\":\"John\", \"email\":\"john@example.com\", \"age\":30}"},
// {"language":"mediumMix","code":"Statistics: μ=85, σ=12. Z-score=(X-μ)/σ. Q1=25%, Q3=75%. CI 95%: ±1.96σ. P-value<0.05 → significant. Dataset: n=250, R²=0.72."},
// {"language":"mediumMix","code":"Electronics: V=IR (Ohm's Law), P=IV. Circuit: 12V battery → 3Ω resistor → LED (2.1V drop). Current I=(12-2.1)/3=3.3A. Use 5W resistor!"},
// {"language":"mediumMix","code":"Medical dose: 7mg/kg/day ÷ q12h (max 500mg/dose). For 60kg patient: 210mg/day → 105mg q12h. Dispense #60 (30-day supply). Caution: renal impair."},
// {"language":"mediumMix","code":"Engineering: Stress σ=F/A (Pa), Strain ε=ΔL/L₀. Young's Modulus E=σ/ε. Beam deflection δ=5wL⁴/384EI. Safety factor: 2.5× working load."},
// {"language":"mediumMix","code":"Programming: def factorial(n): return 1 if n==0 else n*factorial(n-1) # Recursion\nTime complexity: O(n). Max depth: 997 (Python default)."},
// {"language":"mediumMix","code":"Economics: GDP=C+I+G+(X-M). CPI 2022→2023: 280→294 (5% inflation). Unemployment: 3.8%. Fed rate: 5.25-5.50%. Trade deficit: $67B."},
// {"language":"mediumMix","code":"Astronomy: 1AU=1.496×10⁸km. H-R diagram: L∝R²T⁴. Hubble's Law: v=H₀d (H₀≈70km/s/Mpc). Solar mass: 1.989×10³⁰kg. Redshift z=Δλ/λ₀."},
// {"language":"mediumMix","code":"Music theory: Cmaj7 (C-E-G-B), V⁷→I cadence. 4/4 time @120bpm = 0.5s/beat. Equal temp.: fₙ=440×2^(n/12). MIDI note #60 = Middle C."},
// {"language":"mediumMix","code":"Photography: f/2.8, 1/500s, ISO400. Sunny 16 rule: f/16, 1/ISO s. DoF ∝ f-stop × distance². 35mm equiv: crop factor × focal length."},
// {"language":"mediumMix","code":"Nutrition: 2000kcal diet = 50g protein (10%), 300g carbs (60%), 44g fat (30%). RDAs: VitC 90mg, Ca 1000mg, Fe 8mg (men)/18mg (women)."},
// {"language":"mediumMix","code":"Geography: Mt. Everest 8,848m, Mariana Trench -10,984m. Earth circ: 40,075km (equator). Time zones: 24, each 15° longitude. Pop: ~8B (2023)."},
// {"language":"hardMix","code":"Quantum mechanics: [x̂,p̂]=iℏ, ψ(x,t)=∫dp ϕ(p)exp[i(px-Et)/ℏ]. EPR paradox: ρAB=|Ψ⁻⟩⟨Ψ⁻|, where |Ψ⁻⟩=(|01⟩-|10⟩)/√2. Bell's inequality: S=|E(a,b)-E(a,b')|+|E(a',b)+E(a',b')|≤2."},
// {"language":"hardMix","code":"General relativity: Gμν=8πG/c⁴ Tμν. Schwarzschild metric: ds²=-(1-2GM/rc²)dt²+(1-2GM/rc²)⁻¹dr²+r²dΩ². Gravitational redshift: Δλ/λ=GM/(Rc²)."},
// {"language":"hardMix","code":"Organic chemistry: (S)-2-bromobutane + NaOH/EtOH → (R)-2-butanol (SN2, inversion). NMR: δ7.2-7.4 (5H, m, Ar-H), δ4.3 (1H, q, J=6.5Hz, CH-O)."},
// {"language":"hardMix","code":"Machine learning: ∇θJ(θ)=(1/m)Xᵀ(g(Xθ)-y)+λθ, where g(z)=1/(1+e⁻ᶻ). Adam optimizer: mₜ=β₁mₜ₋₁+(1-β₁)gₜ, vₜ=β₂vₜ₋₁+(1-β₂)gₜ², θₜ₊₁=θₜ-ηm̂ₜ/(√v̂ₜ+ε)."},
// {"language":"hardMix","code":"Thermodynamics: dS≥δQ/T, μ=(∂G/∂n)T,P. Maxwell relations: (∂T/∂V)S=-(∂P/∂S)V. Carnot efficiency: η=1-Tc/Th. Critical point: (∂P/∂V)T=(∂²P/∂V²)T=0."},
// {"language":"hardMix","code":"Electrodynamics: ∇·E=ρ/ε₀, ∇×B=μ₀J+μ₀ε₀∂E/∂t. Lienard-Wiechert potentials: V(r,t)=q/(4πε₀|r-rₛ|(1-β·n)). Poynting vector: S=E×H."},
// {"language":"hardMix","code":"Number theory: e^π√163 ≈ 262537412640768744 (within 10⁻¹² of integer). Riemann ζ(s)=∏(1-p⁻ˢ)⁻¹. Modular forms: Δ(z)=q∏(1-qⁿ)²⁴, q=e²πⁱᶻ."},
// {"language":"hardMix","code":"Biochemistry: Michaelis-Menten: v=Vmax[S]/(Km+[S]). Hill equation: Y=[L]ⁿ/(Kd+[L]ⁿ). Hemoglobin: p50=26mmHg, n≈2.8 (cooperative binding)."},
// {"language":"hardMix","code":"Astrophysics: Jeans mass: MJ≈(5kT/Gμmp)^(3/2)(3/4πρ₀)^(1/2). Chandrasekhar limit: MCh≈1.4M☉. Hubble time: tH≈1/H₀≈14Gyr (for H₀=70km/s/Mpc)."},
// {"language":"hardMix","code":"Topology: Homeomorphism f:X→Y continuous, bijective, f⁻¹ continuous. Brouwer fixed-point: f:Dⁿ→Dⁿ has x s.t. f(x)=x. Genus g=# holes (torus: g=1)."},
// {"language":"hardMix","code":"Linguistics: IPA /ðiː kwɪk brɔːn fɒks dʒʌmpt əʊvə ðə leɪzi dɒɡ/. Syntactic tree: [S [NP [Det The] [N' [Adj quick] [N fox]] [VP [V jumped] [PP over...]]]."},
// {"language":"hardMix","code":"Cryptography: RSA: Choose primes p,q; n=pq; φ(n)=(p-1)(q-1); e s.t. gcd(e,φ(n))=1; d≡e⁻¹ mod φ(n). Public key: (n,e), Private: (n,d). C≡Mᵉ mod n."},
// {"language":"hardMix","code":"Fluid dynamics: Navier-Stokes: ρ(∂v/∂t+v·∇v)=-∇p+μ∇²v+f. Reynolds number Re=ρvL/μ. Bernoulli: p+½ρv²+ρgh=constant. Vorticity ω=∇×v."},
// {"language":"hardMix","code":"Neuroscience: Hodgkin-Huxley: CmdV/dt=-gₙₐm³h(V-Eₙₐ)-gₖn⁴(V-Eₖ)-gₗ(V-Eₗ)+Iₑₓₜ. Action potential: Vₘ≈-70mV→+30mV→-80mV (undershoot)."},
// {"language":"hardMix","code":"Materials science: Bragg's law: nλ=2d sinθ. Burgers vector b in dislocations. Hall-Petch: σy=σ₀+kd^(-1/2). Phase diagram: eutectic at 72%Ag-28%Cu (779°C)."},
// {"language":"hardMix","code":"Pharmacokinetics: C(t)=D/Vd·e^(-kt), t½=ln(2)/k. Clearance CL=k·Vd. AUC=D/CL. Bioavailability F=AUCₚₒ/AUCᵢᵥ. Therapeutic index: LD50/ED50."},
// {"language":"hardMix","code":"Quantum chemistry: Hartree-Fock: Fψᵢ=εᵢψᵢ, F=h+∑(2Jⱼ-Kⱼ). Slater determinant: |ψ₁ψ̄₁ψ₂ψ̄₂...ψₙψ̄ₙ|. Born-Oppenheimer: ∇²χ+(2M/ℏ²)(E-Eₑₗ)χ=0."},
// {"language":"hardMix","code":"Control theory: State-space: ẋ=Ax+Bu, y=Cx+Du. PID: u(t)=Kₚe(t)+Kᵢ∫e(τ)dτ+Kₚde/dt. Nyquist: N=Z-P (encirclements of -1)."},
// {"language":"hardMix","code":"Computational complexity: P vs NP. SAT is NP-complete (Cook-Levin). Big-O: O(n log n) for mergesort. Turing machine: δ:Q×Γ→Q×Γ×{L,R}."},
// {"language":"hardMix","code":"Particle physics: Standard Model Lagrangian: ℒ= -¼FμνF^μν + iψ̄γμDμψ + |Dμϕ|² - V(ϕ) + yψ̄ϕψ. Feynman rules: QED vertex: -ieγμ. β-decay: n→p+e⁻+ν̄ₑ."}
];
